...
Comodino.prototype.get3DModel = function() {
	...
	//Materiali
	var mat_grigio = new THREE.MeshLambertMaterial( {color: 0xdcdcdc} );
	var fronte_mat = new THREE.MeshLambertMaterial( {color: 0xdcdcdc} );
	var rivista_mat = new THREE.MeshLambertMaterial( {color: 0xffffff} );
