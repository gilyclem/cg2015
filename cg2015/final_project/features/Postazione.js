...
Postazione.prototype.get3DModel = function() {
	...
	var spessore = new THREE.Mesh(new THREE.BoxGeometry(1.5,1,0.04), mat_nero);
	var monitor = new THREE.Mesh(new THREE.PlaneGeometry(1.5,1), monitor_mat);
