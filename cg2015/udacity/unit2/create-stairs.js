...
function createStairs() {
	...
	var i=0;	//indice
	while(((stepThickness/2 + verticalStepHeight)+i*(verticalStepHeight+stepThickness))<1525)
	{
	...
	stepMesh.position.y = i*(verticalStepHeight+stepThickness)+(verticalStepHeight+stepHalfThickness);
