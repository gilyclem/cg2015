...
function createBody() {
	...
	var cylinderGeometry=new THREE.CylinderGeometry(12.5,12.5,cylinderHeight,32);
	var sphere = new THREE.Mesh(sphereGeometry,sphereMaterial);
	sphere.position.y= 100;
	var cylinder = new THREE.Mesh(cylinderGeometry,cylinderMaterial);
	cylinder.position.y= 100+sphereRadius+cylinderHeight/2;
	scene.add(cylinder);
	scene.add(sphere);
}
...
function createHead() {
	...
	var sphereGeometry = new THREE.SphereGeometry(sphereRadius,32,16);
	var sphere = new THREE.Mesh(sphereGeometry,sphereMaterial);
	var cylinderGeometry2=new THREE.CylinderGeometry(40,40,80,32);
	var cylinderGeometry1=new THREE.CylinderGeometry(80,80,10,32);
